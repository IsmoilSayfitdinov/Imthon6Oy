import "../cardItemsview/cardsView.scss"
import React from 'react'
import { useParams } from 'react-router-dom'
import { useEffect , useState } from 'react'
import Star from "../../assets/img/Star.png"
import CardCarusel from "../../componets/carusleCard/cardCarusel"
    ...
    <div className='main__view'>
       ...
       <div className="img__cardView">
         ...
         <div className="reputatu__date">
             ...
             <div className="data">
                 <p className="relese_data-card">release_date: {isView?.release_date}</p>
             </div>
             <strong>{isView?.vote_count} vote_count</strong>
         </div>
       </div>
